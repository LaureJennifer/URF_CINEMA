using BaseSolutio.Client.Repositories.Implements;
using BaseSolution.Application.Interfaces.Repositories.ReadOnly;
using BaseSolution.Application.Interfaces.Repositories.ReadWrite;
using BaseSolution.Client.Repositories;
using BaseSolution.Client.Repositories.Implements;
using BaseSolution.Client.Repositories.Interfaces;
using BaseSolution.Infrastructure.Implements.Repositories.ReadOnly;
using BaseSolution.Infrastructure.Implements.Repositories.ReadWrite;
using Microsoft.AspNetCore.Components.Authorization;

namespace BaseSolution.Client.Data.Extensions
{
