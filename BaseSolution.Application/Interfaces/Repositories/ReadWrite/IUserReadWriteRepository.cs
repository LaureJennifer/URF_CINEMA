...
namespace BaseSolution.Application.Interfaces.Repositories.ReadWrite
{
    public interface IUserReadWriteRepository
    {
        ...
        Task<RequestResult<bool>> UpdateUserAsync(UserEntity entity, CancellationToken cancellationToken);
        Task<RequestResult<bool>> DeleteUserAsync(UserDeleteRequest request, CancellationToken cancellationToken);
    }
}
