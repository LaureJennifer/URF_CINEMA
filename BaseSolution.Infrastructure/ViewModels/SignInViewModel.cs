...
{
    public class SignInViewModel : ViewModelBase<LoginInputRequest>
    {
        private readonly ILoginService _loginService;
        private readonly ILocalizationService _localizationService;
        public SignInViewModel(ILoginService loginService, ILocalizationService localizationService)
        {
        ...
        public async override Task HandleAsync(LoginInputRequest data, CancellationToken cancellationToken)
        {
            try
            {
                var result = await _loginService.SignIn(data);
                Data = result.Data!;
